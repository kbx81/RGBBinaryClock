...
//     {
//       _displayBufferOut[(cPwmChannelsPerDevice * cPwmNumberOfDevices) - 1 - chan] = pwm;
//     }
//     else
//     {
...
{
  timer_set_oc_value(TIM2, TIM_OC1, _statusLed.getRed());
  timer_set_oc_value(TIM2, TIM_OC3, _statusLed.getGreen());
  timer_set_oc_value(TIM2, TIM_OC4, _statusLed.getBlue());
}
...
void redLed(const uint32_t intensity)
{
  if (intensity <= Display::cLedMaxIntensity)
  {
    timer_set_oc_value(TIM2, TIM_OC1, intensity);
