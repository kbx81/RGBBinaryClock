...
namespace Hardware {
  ...
  static const uint8_t  cAlarmInputPinCount = 1;
  static const uint16_t cAlarmInputPins[cAlarmInputPinCount] = { GPIO13 };
  ...
  //
  static const auto cLedPort    = GPIOA;
  static const auto cLed0Pin    = GPIO15;
  static const auto cLedAltPort = GPIOB;
  static const auto cLed1Pin    = GPIO10;
  static const auto cLed2Pin    = GPIO11;

  static const auto cLedPortAF  = GPIO_AF2;

  static const auto cLedPwmTimer = TIM2;
  static const auto cLed0PwmOc   = TIM_OC1;
  static const auto cLed1PwmOc   = TIM_OC3;
  static const auto cLed2PwmOc   = TIM_OC4;
  ...
  static const auto cCurrentDriveLowPin  = GPIO8;
  static const auto cCurrentDriveHighPin = GPIO9;
  ...
  //
  static const auto cTscSamplingCapPins = GPIO2 | GPIO3 | GPIO14;

  // pins used for touch keys
  //
  static const auto cTscTouchKeyPins = GPIO0 | GPIO1 | GPIO6 | GPIO7 | GPIO12 | GPIO13;
